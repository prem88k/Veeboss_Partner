...
class AppliedUserCountList extends StatefulWidget {
  List<AppliedUser>? appliedList;
  AppliedUserCountList(this.appliedList);

  @override
  State<AppliedUserCountList> createState() => _AppliedUserCountListState();
}

class _AppliedUserCountListState extends State<AppliedUserCountList> {
  ...
  Future<void> _launchWhatsapp(String? contactNo, AppliedUser appliedUser,  ) async {

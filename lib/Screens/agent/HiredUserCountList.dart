...
class HiredUserCountList extends StatefulWidget {
  List<HiredUser>? appliedList;
  HiredUserCountList(this.appliedList);

  @override
  State<HiredUserCountList> createState() => _HiredUserCountListState();
}

class _HiredUserCountListState extends State<HiredUserCountList> {
  ...
  Future<void> _launchWhatsapp(String? contactNo, HiredUser appliedUser,  ) async {

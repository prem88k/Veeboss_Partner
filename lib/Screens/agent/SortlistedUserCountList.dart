...
class SortlistedUserCountList extends StatefulWidget {
  List<Sortlisted>? appliedList;
  SortlistedUserCountList(this.appliedList);

  @override
  State<SortlistedUserCountList> createState() => _SortlistedUserCountListState();
}

class _SortlistedUserCountListState extends State<SortlistedUserCountList> {
  ...
  Future<void> _launchWhatsapp(String? contactNo, Sortlisted appliedUser,  ) async {
